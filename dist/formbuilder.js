  ...
  Formbuilder = (function() {
    ...
    Formbuilder.options = {
      ...
      dict: {
        ...
        SET_IMPORT_PERSONA_FILE: 'Set the Survey file here, to start your design from an existing persona.',
        SET_IMPORT_PERSONA_JSON: 'Paste the Survey JSON here, to start your design from an existing persona.',
        SET_IMPORT_PERSONA_URI: 'Paste the Survey URI here, to start your design from an existing persona.',
        SET_APP_NAME: 'Survey Name...',
        ...
        DOWNLOAD_PERSONA: 'Download The Survey',
        SET_THEATRE_URI: 'Theatre Address',
        SET_TRANSPORT_MODE: 'How the Survey App will submit data',
        EMPTY_FIELDS_MESSAGE: 'The survey is currently empty! Start designing, by dragging and dropping fields onto the survey canvas below...'
      }
    };
